...
<head>
    ...
    <title>Cetak Struk - Transaksi #{{ $transaction->id }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="receipt-container">
        ...
        <div class="summary-section">
            <div class="summary-row subtotal">
                ...
                <span class="summary-value">Rp {{ number_format($transaction->total) }}</span>
            </div>
            <div class="summary-row payment">
                <span class="summary-label">Bayar:</span>
                <span class="summary-value">Rp {{ number_format($transaction->payment) }}</span>
            </div>
            <div class="summary-row change">
                <span class="summary-label">Kembalian:</span>
                <span class="summary-value">Rp {{ number_format($transaction->change) }}</span>
            </div>
        </div>

        <div class="receipt-footer">
            <div class="thank-you">Terima Kasih!</div>
            <div>Semoga Anda menikmati pengalaman menyewa di Campgear Hub.</div>
